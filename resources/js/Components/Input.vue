<template>
  <div :class="group_classes">
    ...
    <div ref="list" v-show="autocompleteData && showSuggestion && !recordSelectedLast" class="autocomplete-container">
  ...
  export default {
    ...
    methods: {
      ...
      async fetchAutocomplete(value){
        if(this.recordSelectedLast === true) {
          this.recordSelectedLast = false
          this.showSuggestion = false
          return
        }
